...
function aboutMe() {
	var aboutMeArray = ['>About:', 'Hi There!', 'I\'m Abdi, a dropout student and a self taught programmer, I make Apps and websites full-time, and Generative arts part-time.', `Feel free to follow me on twitter ${aboutMeTwitter} - Also see contact page for more socials.`];
	seperator();
